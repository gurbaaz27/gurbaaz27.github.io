...
> **Go check out the extension [here](https://marketplace.visualstudio.com/items?itemName=gurbaaz.codrop). Feel free to install and use, and report bugs (if any) at hi [at] gurbaaz [dot] xyz**
...
<figure><img src="/assets/img/blogs/codrop-demo.gif" alt="Extension Demo"><figcaption>Extension Demo</figcaption></figure>
